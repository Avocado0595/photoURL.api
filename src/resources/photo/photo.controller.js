...
export default class photoController{
    ...
    getPhotoListByUser = async(req, res)=>{
        try{
            ...
            return res.status(200).json(createResponse(true, "Get list photo successfully.", photoList));
        }
        catch(err){
    ...
    getPhotoById = async (req, res)=>{
        try{
            ...
            return res.status(200).json(createResponse(true, "Get photo successfully.", photo));
        }
        catch(err){
    ...
    create = async (req, res) =>{    
        try{
            ...
            return res.status(201).json(createResponse(true,"Create new photo successfully.",photo));
        }
        catch(err){
            return res.status(400).json(createResponse(false,err.message,null));
        }
    ...
    update = async(req, res) =>{
        try{
            ...
            return res.status(201).json(createResponse(true, "Update photo successfully.", photo));
        }
        catch(err){
            return res.status(400).json(createResponse(false, err.message, null))
        }
    ...
    delete = async(req, res)=>{
        try{
            ...
            return res.status(200).json(createResponse(true, "Delete photo successfully.", photo));
        }
        catch(err){
            return res.status(400).json(createResponse(false, err.message, null))
        }
    ...
    like = async(req, res)=>{
        try{
            ...
            return res.status(201).json(createResponse(true, "Liked.",result ));
        }
        catch(err){
            return res.status(400).json(createResponse(false, err.message, null))
        }
